# Karma Chameleon Copyright (C) 2018 Dustin Schoenbrun
#
...
"""
Implements an item which stores a name and that thing's karma score as a factor of number
...
class KarmaItem:
    ...
    def total_score(self) -> int:
        ...
        Returns: The current total score of the KarmaItem.
        """
    ...
    def dict_to_karma_item(a_dict: dict):
        ...
        This method is intended to be used as the object_hook parameter when we call
        json.load() to load our existing karma items from a saved JSON file into memory in
        our KarmaBot object.  :param a_dict: A dictionary representing a KarmaItem object.
        :return: A new KarmaItem object with the values from a_dict or a_dict if it's not
        a representation of a KarmaItem
        """
